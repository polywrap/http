    ...
    publishing {
        ...
        publications.withType<MavenPublication> {
            ...
            pom {
                ...
                scm {
                    connection.set("scm:git:github.com/polywrap/http.git")
                    developerConnection.set("scm:git:ssh://github.com/polywrap/http.git")
                    url.set("https://github.com/polywrap/http.git")
                }
            }
        }
    }
